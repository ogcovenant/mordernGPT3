...
const Hero = () => {
  return (
    <div className="bg-gradient-to-r from-[#1b3357] to-[#040C18] p-5 flex items-center justify-between">
      <div className="w-1/2 p-8">
        <h1 className="text-7xl font-bold bg-gradient-to-r from-[#AE67FA] to-[#F49867] bg-clip-text text-transparent">
        ...
        <div className="mt-3">
          <input 
            ...
            type="text"
          />
          <button className="w-1/4 text-white bg-[#FF4820] p-5 text-sm">
            Get Started
          </button>
        </div>
      </div>
